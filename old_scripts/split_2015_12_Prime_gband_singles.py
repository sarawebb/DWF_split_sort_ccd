...
input_path = '/home/swebb/oz100/NOAO_archive/archive_NOAO_data/data/2015/12/Prime/g_band/single/'
output_path = '/home/swebb/oz100/NOAO_archive/archive_NOAO_data/data_outputs/'

thresh = np.arange(1, 2.5, 0.5)
ext = np.arange(0,60, 1)
